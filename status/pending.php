...
<html class="supports-animation supports-columns svg no-touch no-ie no-oldie no-ios supports-backdrop-filter as-mouseuser" lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="application-name" content="detail">
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                        ...
                                        <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                                            <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink" data-relatedlink="6|Powerbeats3 Wireless Earphones - Neighborhood Collection - Brick Red|MPXP2">
                                                <div class="as-tilegallery-element as-image-selected">
                                                    <div class=""></div>
                                                    <img src="../assets/status/pending.gif" class="ir ir item-image as-producttile-image" alt="" width="445" height="445" style="content:-webkit-image-set(url(../assets/status/pending.gif) 2x);">
                                                </div>
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                        ...
                                        <div class="as-producttile-title">
                                            <h3 class="as-producttile-name">
                                                <p class="as-producttile-tilelink">
                                                    El pago esta pendiente. En un tiempo recibiras la notificacion del resultado del pago
                                    ...
                                    <button type="button" class="mercadopago-button" onclick="window.location.replace('../index.php')">Volver a la tienda</button>
